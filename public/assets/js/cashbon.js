...
$("#btn-submit").click(function(){
    ...
    var alasan_cashbon = $("#alasan_cashbon").val()
...
function deleteCashbon(id)
{
    ...
    $.ajax({
        ...
        error:function(){
            ...
            $(namaBtn).html('<i class="bi bi-trash"></i>')
